                            ...
                            <div className="col-xl-3 col-lg-3 col-sm-6">
                                <div className="footer-widget mb-30">
                                    ...
                                    <div className="footer-text mb-20">
                                        <p>Comprehensive billing solutions for medical facilities. Streamlining healthcare payments with accuracy and efficiency.</p>
                                    </div>
                                        ...
                                        <div className="f-contact">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <span><a href="mailto:billing@example.com">billing@example.com</a><br /><a href="mailto:support@example.com">support@example.com</a></span>
                                                </li>
                                                <li>
